...
// २. पडदा उघडण्याचे (Curtain Opening) मुख्य लॉजिक
...
if (openCurtainBtn && curtainOverlay) {
  openCurtainBtn.addEventListener('click', function() {
    // पडदा दोन्ही बाजूंना सरकवणे
    curtainOverlay.classList.add('open');

    // बॅकग्राउंड संगीत सुरू करणे
    ...
    // १.८ सेकंदात पडदा उघडल्यावर त्याला स्क्रीनवरून पूर्ण हटवणे
    setTimeout(() => {
